...
public class AnimalDetailFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if (mItem != null) {
            ((ImageView) rootView.findViewById(R.id.imgAnimal)).setImageResource(mItem.imagen);
            ((TextView)rootView.findViewById ( R.id.tvNombre)).setText ( mItem.nombre );
            ((TextView)rootView.findViewById ( R.id.tvDescripcion)).setText ( mItem.descripcion);
